...
import hiroshi_homma.homma_create.hiroshi_create_android.feature.homma_create_processing.presentation.activity.DetailsActivity
import hiroshi_homma.homma_create.hiroshi_create_android.feature.homma_create_processing.data.viewmodeldata.TopView
import hiroshi_homma.homma_create.hiroshi_create_android.feature.homma_create_processing.presentation.activity.TopActivity
...
@Inject constructor() {
    ...
    private fun showMovies(context: Context) = context.startActivity(TopActivity.callingIntent(context))

    fun showMovieDetails(activity: FragmentActivity, top: TopView, navigationExtras: Extras) {
        val intent = DetailsActivity.callingIntent(activity, top)
